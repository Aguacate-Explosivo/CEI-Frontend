...
<head>
        ...
        <div class="container-fluid">
          ...
          <nav aria-label="...">
              <ul class="pagination pagination-lg justify-content-center">
                  <li class="page-item active" aria-current="page"><a class="page-link" href="Dashestudiante.php">Añadir un nuevo Estudiante</a></li>
                  <li class="page-item"><a class="page-link" href="administradores/adminestudiantes.php">Administrar Estudiante Destacados </a></li>
  ...
  .input-group .input-group-append {
    ...
    z-index: 10;
          ...
          <!-- Fin de navegacion -->
          <form action="administradores/regeestudiante.php" required=" " method="POST" enctype="multipart/form-data">
