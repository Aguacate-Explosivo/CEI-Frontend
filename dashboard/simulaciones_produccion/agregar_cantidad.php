                                                ...
                                                <main>
                                                      ...
                                                      <label for="nombre" class="form__label"> Nombre del Lider del Negocio</label>
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            placeholder="Cantidad de productos a Producir :" required pattern="[0-9 .]+" >
                                                            <button class="btn btn-outline-secondary" type="button" data-toggle="tooltip" data-placement="top" title="Aqui debes proporcionar la cantidad de productos que tu quieras producir ">
