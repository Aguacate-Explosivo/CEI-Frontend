            ...
            <div class="col-md-12">
              <div class="white-box">
                ...
                <div class="container-fluid">
                  ...
                  <li class="page-item " aria-current="page"><a class="page-link" href="../Dashactividades.php">Añadir una nueva Actividades</a></li>
                  <li class="page-item active"><a class="page-link" href="administradores/adminactividades.php">Administrar Actividades </a></li>
  ...
  .course-image {
    border-radius: 10px;
      ...
      object-fit: cover; 
                        ...
                        $descripcion_words = explode(' ', $elemento["descripcion"]);
                        ...
                        if (str_word_count($elemento["descripcion"]) > 10) {
                            echo '...';
                        }
                        ?></td>
                                ...
                                <a style="margin: 2px; border-radius: 5px;" href="eliminaractividad.php?id=<?php echo $elemento["id"]?>" class="btn btn-danger" > <i class="fas fa-trash-alt fa-flip-horizontal"></i></a>
                                 </td>
                            </tr>
