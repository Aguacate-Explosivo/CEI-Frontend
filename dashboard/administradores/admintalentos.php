      ...
      <div id="page-wrapper">
        <div class="container-fluid">
          <div class="row bg-title">
            <div class="col-lg-12">
              <h4 class="page-title">Puedes gestionar tus talentos desde este modulo</h4>
              <ol class="breadcrumb">
              </ol>
            </div>
            <!-- /.col-lg-12 -->
            ...
            <div class="col-md-12">
              <div class="white-box">
                ...
                <div class="container-fluid">
                  ...
                  <li class="page-item " aria-current="page"><a class="page-link" href="../Dashtalento.php">Añadir un nuevo Talento</a></li>
                  <li class="page-item active"><a class="page-link" href="administradores/admintalentos.php">Administrar Talento Humano </a></li>
      ...
      object-fit: cover; 
                        ...
                        <thead>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center; vertical-align: middle;"><?php echo $elemento["descripcion"]; ?></td>
                                ...
                                <a style="margin: 2px; border-radius: 5px;" href="eliminartalento.php?id=<?php echo $elemento["id"]?>" class="btn btn-danger" > <i class="fas fa-trash-alt fa-flip-horizontal"></i></a>
                                 </td>
                            </tr>
