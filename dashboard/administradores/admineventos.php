                    ...
                    <div class="table-responsive">        
                        ...
                        <thead>
                            ...
                            <tr>
                                ...
                                <td>
                                <a href="evento.php?id_evento=<?php echo $elemento["id_evento"]?>" class="btn btn-warning" > editar</a>
                                <a href="eliminarevento.php?id_evento=<?php echo $elemento["id_evento"]?>" class="btn btn-danger" > eliminar</a>
                                 </td>
                            </tr>
