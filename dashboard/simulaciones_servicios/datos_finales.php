<?php
  ...
  if(isset($_POST["Siguiente"])){
    ...
    //Datos del formulario 1
      ...
      header("location:agregar_cantidad.php");
  }
  ...
  ADD PRIMARY KEY (`id`); ";
   ...
   $creartabla3 ="  ALTER TABLE ` $nombre_negocio_plan`
     ...
     ADD PRIMARY KEY (`id`); ";
      ...
      $creartabla3g ="  ALTER TABLE ` $documento`
       ...
       $creartabla4g=mysqli_query($conexion,$creartabla3g);
        ...
        //agregar tabla de costos  a base de datos
    ...
    $creartablag3 ="CREATE TABLE ` $nombre` (
     ...
     $creartabla3g =" ALTER TABLE ` $nombre`
     ADD PRIMARY KEY (`id`); ";
      $creartabla4=mysqli_query($conexion,$creartabla3g);
      
      $creartabla4g ="  ALTER TABLE ` $nombre`
       CHANGE `id` `id` INT(11) NOT NULL AUTO_INCREMENT; ";
       $creartabla5g=mysqli_query($conexion,$creartabla4g);
                                                ...
                                                <main>
                                                    <form required method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="number" id="clientes_interesados_plan" name="clientes_interesados_plan" class="form-control" placeholder="Ingrese el número de potenciales clientes " required pattern="[0-9]+"  >
