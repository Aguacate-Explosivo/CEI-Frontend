      ...
      <div class="wrapper" style="background: white; width: 1200px;  max-height: 10000px; margin: auto;">
        <div class="">
          <div class="row bg-title">
            <div class="col-lg-12">
              <h4 class="page-title">Quinto Paso Agregar Materia de servicios </h4>
          ...
          <!-- inicio-->
<hr>
<form class="range-form" action="regismateria.php" required=" " method="POST" enctype="multipart/form-data" >
 <div class="inicio">
    <div class="scroll">
    <br>
<br>
...
<br>
    ...
    placeholder="Nombre de Materia de Servicio:" required=""  maxlength="16" minlength="1" pattern="[a-zA-ZÁÉÍÓÚáéíóúñ 0-9-,.]+"  >
    <button class="btn btn-outline-secondary" type="button" data-toggle="tooltip" data-placement="top" title="Aqui debes proporcionar el NOMBRE de cada Materia de servicio que se valla a usar para ofrecer el servicio ">
...
<br>
  ...
  <div class="input-group">
    ...
    placeholder="Coste Mensual de Materia de servicio:" required pattern="[0-9]+" >
    <button class="btn btn-outline-secondary" type="button" data-toggle="tooltip" data-placement="top" title="Aqui debes proporcionar el VALOR MENSUAL DE CADA UNA DE TUS MATERIAS De servicioque se Necesiten ssss  ">
     <i class="fas fa-question"></i>
      </button>
...
<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <?php
                                 ...
                                 $consulta21 ="SELECT SUM(cantidad) as suma_total  FROM ` $nombre_negocio_plan` ";
                                 $busqueda1=mysqli_query($conexion,$consulta21);
                                 $total222= mysqli_fetch_array($busqueda1);
                                 $cantidad_producto = $total222['suma_total'];
                       ...
                       <div class="inicio">
                         <div class="scroll">
                       <div class="col-md-9">
                       <label for="importe" class="form__label">Porsentaje de IVA </label>
    <div class="input-group">
    <input type="text"   maxlength="4" minlength="1" class="form-control" id="importe" value="19" name="importe"
    placeholder="IVA :" required pattern="[0-9 .]+" >
    ...
    <button  value="Siguiente" name="Siguiente"  type="submit" class="btn btn-warning btn-block btn-rounded waves-effect waves-light">Siguiente</button>  
