      ...
      <div class="wrapper" style="background: white; width: 80%; margin: auto;">
        <div class="container-fluid">
          <div class="row bg-title">
            <div class="col-lg-12">
              <h4 class="page-title">Septimo Paso Agregar Costos De Utilidades </h4>
          ...
          <!-- inicio-->
<hr>
<form class="range-form" action="regiscosto.php" required=" " method="POST" enctype="multipart/form-data" >
 <div class="inicio">
    <div class="scroll">
      <br><br><br><br><br><br>
    <div class="col-md-16">
    ...
    placeholder="Nombre del Costos De Utilidades :" required=""  maxlength="16" minlength="1" pattern="[a-zA-ZÁÉÍÓÚáéíóúñ 0-9-,.]+"  >
    <button class="btn btn-outline-secondary" type="button" data-toggle="tooltip" data-placement="top" title="Aqui debes proporcionar el NOMBRE de cada COSTO De Utilidad">
...
<br>
  <div class="col-md-16">
    ...
    placeholder="Valor del Costos De Utilidades :" required="" pattern="[0-9]+" >
    <button class="btn btn-outline-secondary" type="button" data-toggle="tooltip" data-placement="top" title="Aqui debes proporcionar el VALOR  de cada uno de los costos De Utilidades ">
     <i class="fas fa-question"></i>
      </button>
...
<br>
<button type="submit" class="btn btn-success btn-block btn-rounded waves-effect waves-light">Agregar Costos</button>
...
<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                <th style="text-align: center; height: 40px; vertical-align: middle;">Costos</th>
                                ...
                                <?php
                                 ...
                                 $conexion=conectar(); 
                                 $consulta2 ="SELECT * FROM ` $nombre` ";
                                 $busqueda=mysqli_query($conexion,$consulta2);
                                   
                                 $consulta21 ="SELECT SUM(valor) as valor_total_costo  FROM ` $nombre` ";
                                 $busqueda1=mysqli_query($conexion,$consulta21);
                                 $total11= mysqli_fetch_array($busqueda1);
                                 $valor_total_costo = $total11['valor_total_costo'];
                                 $valor_total_costos = $valor_total_costo;                                                            
                                 $valor_total_costoss = number_format($valor_total_costos, 2 ,',', '.');
                            ...
                            <tr>
                                ...
                                <thead>
                                <tr><th ></th>
                                <th style="text-align: center;  vertical-align: middle;"><?php echo $valor_total_costoss; ?></th>
  ...
  <button style="width: 300px; left:40px; height: 50px; "  value="Siguiente" name="Siguiente"  type="submit" class="btn btn-warning btn-block btn-rounded waves-effect waves-light">Siguiente</button>  
   ...
   <div>
                                                            ...
                                                            <input type="hidden" id="valor_total_costo" name="valor_total_costo" value="<?php echo $valor_total_costos; ?>">
