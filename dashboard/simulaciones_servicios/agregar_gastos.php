      ...
      <div class="wrapper" style="background: white; width: 80%; margin: auto;">
        <div class="container-fluid">
          <div class="row bg-title">
            <div class="col-lg-12">
              <h4 class="page-title">Sexto Paso Agregar Gastos FIJOS Mensuales</h4>
...
<form class="range-form" action="regisgasto.php" required=" " method="POST" enctype="multipart/form-data" >
 <div class="inicio">
    ...
    placeholder="Nombre del gasto Fijo Mensual:" required=""  maxlength="16" minlength="1" pattern="[a-zA-ZÁÉÍÓÚáéíóúñ 0-9-,.]+"  >
    <button class="btn btn-outline-secondary" type="button" data-toggle="tooltip" data-placement="top" title="Aqui debes proporcionar el NOMBRE de cada GASTO FIJO MENSUAL son todos los que conllevan hacerce mensualmente ">
...
<br>
  <div class="col-md-16">
    ...
    placeholder="Valor del gasto Fijo Mensual:" required="" pattern="[0-9]+" >
    <button class="btn btn-outline-secondary" type="button" data-toggle="tooltip" data-placement="top" title="Aqui debes proporcionar el VALOR  de cada uno de los gastos Fijos Mensuaeles">
     <i class="fas fa-question"></i>
      </button>
