...
<br>
  <div class="col-md-9">
    ...
    placeholder="Cantiad producto:" required pattern="[0-9]+" >
    </div>
<br>
<br>
<br>
...
<div>
 <br>
<br>
 <a href="producto.php" class="btn btn-info btn-block btn-rounded waves-effect waves-light">
  Regresar</a>
</div>
</form>
</div>
...
<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        <thead>
                            ...
                            <tr>
                                ...
                                <td>
                                <a style="margin: 2px; border-radius: 5px;" href="editarproducto.php?id=<?php echo $elemento["id"]?>" class="btn btn-warning" > Eitar</a>
