      ...
      <div class="navbar-default sidebar nicescroll" role="navigation">
        <div class="sidebar-nav navbar-collapse">
          <ul class="nav" id="side-menu">
            ...
            <li>
              <a href="../DashEventos.php" class="waves-effect active"
      ...
      <div class="container-fluid">
        ...
        <!-- inicio-->
            <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                        <h3 class="text-center">Plan de Negocio</h3>
                                            ...
                                            <div class="row">
                                                <main>
                                                        ...
                                                        <div class="form-floating"> 
                                                            ...
                                                            placeholder="Nombre del plan de negocio:" required pattern="[a-zA-ZÁÉÍÓÚáéíóúñ 0-9 !¡?¿.-,]+" >
                                                          
                                                         </div>
                                                            <br>
                                                        <div class="form-floating">
                                                        <label for="nombren" class="form__label"></label>
                                                            <input type="text"  class="form-control" id="nombren" name="nombren"
                                                            placeholder="Nombre del negociante:" required pattern="[a-zA-ZÁÉÍÓÚáéíóúñ 0-9 !¡?¿.-,]+" >
                                                        </div>
                                                            <br>
